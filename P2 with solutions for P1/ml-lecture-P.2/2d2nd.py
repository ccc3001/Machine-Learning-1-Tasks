...
if __name__ == "__main__":
    # Ex. 1.1.: Generate two random 2D vectors and print them to the console.
    ...
    # Ex. 1.2.: Compute the magnitudes of these vectors and print the values to the console.
    ...
    # Ex. 1.3.: Compute and plot the inner product of these vectors using the plot_inner_product function. The function
    ...
    # Ex. 1.4: Train your intuition. Think of a 2D vector as an image with two pixels, and think of an image of
    ...
    # Ex. 1.5.: Compute the angle between two vectors. Note that you can understand this also as the angle between the two images.
    # First compute the angle between the 2D-vectors generated in Ex. 1.3.
    ...
    # Ex. 1.6.: Use the compute_angle function for images to determine the angle between `cat.jpg` and `dog.jpg`.
