...
if __name__ == "__main__":
    ...
    print(x1)
    show_image((x1*255).reshape(1,2),200)
    # <END Your code here>
    ...
    a = generate_random_vector(20000, True)
    b = generate_random_vector(20000, True)
    ang = compute_angle(a ,b)  # TODO: Overwrite this with the correct angle
    # <START Your code here>
    ...
    # <START Your code here>
    show_image((a*255).reshape(100,200),200)
    show_image((b*255).reshape(100,200),200)
    # <END Your code here>
    ...
    # <START Your code here>
    ang = compute_angle(flatten_matrix(x1),flatten_matrix(x2))
    # <END Your code here>
